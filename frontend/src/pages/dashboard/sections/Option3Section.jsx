...
export default function Option3Section() {
  ...
  useEffect(() => {
    ...
    const subs = Array.from(document.querySelectorAll("#option3 [id^=sub-]"));
      ...
      {[1, 2, 3].map((i) => (
        <section key={i} id={`sub-${i}`} className="p-6 bg-gray-50 rounded">
          <h3 className="text-xl font-semibold mb-2">
            Option 3 — Sub-option {i}
          </h3>
          <p className="text-gray-600">
            Placeholder content for option 3 sub-section {i}. Edit this file to
            add features.
          </p>
