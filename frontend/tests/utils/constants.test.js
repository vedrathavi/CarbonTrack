...
describe('Constants', () => {
  ...
  it('should have auth routes defined', async () => {
    const { AUTH_ROUTES, GET_USER_INFO, LOGOUT_ROUTE } = await import('@/utils/constants');
  ...
  it('should have dashboard route helpers', async () => {
    const { getDashboardToday, getDashboardWeek, getDashboardMonth } = await import('@/utils/constants');
