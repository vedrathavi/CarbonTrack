...
describe('Boundary Testing - TopContributor Component', () => {
  ...
  it('handles single appliance at 100% contribution', () => {
    ...
    render(<TopContributor applianceTotals={mockApplianceTotals} topAppliance="refrigerator" />);
    expect(screen.getByText('100.0%')).toBeInTheDocument();
  });
  ...
  it('handles appliance name with special characters', () => {
    ...
    render(<TopContributor applianceTotals={mockApplianceTotals} topAppliance="ac-unit-2000" />);
